...
#         if plot:
#             plot_eem(sample_r, em_range, ex_range, auto_intensity_range=False, vmin=crange[0], vmax=crange[1],
#                      figure_size=(8, 8), title='Accumulate to component {rank}'.format(rank=r + 1))
#     if rmse:
