    ...
    for axis, itp, mask in zip([interpolation_dimension_o1, interpolation_dimension_o2],
        ...
        if itp == 'zero':
            ...
            if axis == '1d-ex':
                ...
                old_nan_step = np.isnan(intensity_masked)
                ...
                intensity_masked[old_nan_step] = np.nan
...
class HED:
    ...
    def __init__(
            ...
            prior_dict_W=None, prior_dict_H=None, gamma_W=None, gamma_H=None,
    ...
    def fit(self, eem_dataset):
        ...
        model_child = EEMNMF(
            ...
            prior_dict_W={new_order.index(key): value for key, value in self.prior_dict_W.items()},
            prior_dict_H={i: self.prior_dict_H[k] for i, k in enumerate(new_order)},
            gamma_H=gamma_H,
            gamma_W=gamma_W,
        )
