...
def register_callbacks(app):
    ...
    @app.callback(
        [
            Output(IDS.NMF_EEM_DATASET_ESTABLISHMENT_MESSAGE, 'children'),
            Output(IDS.NMF_COMPONENTS, 'children'),
            Output(IDS.NMF_FMAX, 'children'),
            Output(IDS.NMF_ESTABLISHMENT_RECONSTRUCTION_ERROR, 'children'),
            Output(IDS.NMF_SPLIT_HALF, 'children'),
            Output(IDS.NMF_SPINNER, 'children'),
            Output(IDS.NMF_ESTABLISHMENT_CORR_MODEL_SELECTION, 'options'),
            Output(IDS.NMF_ESTABLISHMENT_CORR_MODEL_SELECTION, 'value'),
            # Output(IDS.NMF_ESTABLISHMENT_CORR_REF_SELECTION, 'options'),
            # Output(IDS.NMF_ESTABLISHMENT_CORR_REF_SELECTION, 'value'),
            Output(IDS.NMF_TEST_PRED_REF_SELECTION, 'options'),
            Output(IDS.NMF_TEST_PRED_REF_SELECTION, 'value'),
            Output(IDS.NMF_TEST_MODEL_SELECTION, 'options'),
            Output(IDS.NMF_TEST_MODEL_SELECTION, 'value'),
            Output(IDS.NMF_MODELS, 'data'),
        ],
        [
            Input(IDS.BUILD_NMF_MODEL, 'n_clicks'),
            State(IDS.EEM_GRAPH_OPTIONS, 'value'),
            State(IDS.NMF_EEM_DATASET_ESTABLISHMENT_PATH_INPUT, 'value'),
            State(IDS.NMF_ESTABLISHMENT_INDEX_KW_MANDATORY, 'value'),
            State(IDS.NMF_ESTABLISHMENT_INDEX_KW_OPTIONAL, 'value'),
            State(IDS.NMF_RANK, 'value'),
            ...
            State(IDS.NMF_MAX_ITER_ALS, 'value'),
            State(IDS.NMF_MAX_ITER_NNLS, 'value'),
            State(IDS.NMF_VALIDATIONS, 'value'),
    ...
    @app.callback(
        ...
        [
            Input(IDS.NMF_ESTABLISHMENT_CORR_MODEL_SELECTION, 'value'),
            State(IDS.NMF_MODELS, 'data')
        ]
    )
    ...
    @app.callback(
        [
            Output(IDS.NMF_ESTABLISHMENT_CORR_GRAPH, 'figure'),  # size, intervals?
            Output(IDS.NMF_ESTABLISHMENT_CORR_TABLE, 'children'),
        ],
        [
            Input(IDS.NMF_ESTABLISHMENT_CORR_MODEL_SELECTION, 'value'),
            Input(IDS.NMF_ESTABLISHMENT_CORR_INDICATOR_SELECTION, 'value'),
            Input(IDS.NMF_ESTABLISHMENT_CORR_REF_SELECTION, 'value'),
            State(IDS.NMF_MODELS, 'data')
        ]
    )
    ...
    @app.callback(
        [
            Output(IDS.NMF_EEM_DATASET_PREDICT_MESSAGE, 'children'),  # size, intervals?
            Output(IDS.NMF_TEST_FMAX, 'children'),
            Output(IDS.NMF_TEST_ERROR, 'children'),
            Output(IDS.NMF_TEST_CORR_REF_SELECTION, 'options'),
            Output(IDS.NMF_TEST_CORR_REF_SELECTION, 'value'),
            Output(IDS.NMF_TEST_CORR_INDICATOR_SELECTION, 'options'),
            Output(IDS.NMF_TEST_CORR_INDICATOR_SELECTION, 'value'),
            Output(IDS.NMF_PREDICT_SPINNER, 'children'),
            Output(IDS.NMF_TEST_RESULTS, 'data'),
        ],
        [
            Input(IDS.PREDICT_NMF_MODEL, 'n_clicks'),
            State(IDS.NMF_EEM_DATASET_PREDICT_PATH_INPUT, 'value'),
            State(IDS.NMF_TEST_INDEX_KW_MANDATORY, 'value'),
            State(IDS.NMF_TEST_INDEX_KW_OPTIONAL, 'value'),
            State(IDS.NMF_TEST_MODEL_SELECTION, 'value'),
            State(IDS.NMF_MODELS, 'data')
        ]
    )
    ...
    @app.callback(
        [
            Output(IDS.NMF_TEST_PRED_GRAPH, 'figure'),  # size, intervals?
            Output(IDS.NMF_TEST_PRED_TABLE, 'children'),
        ],
        [
            Input(IDS.PREDICT_PARAFAC_MODEL, 'n_clicks'),
            Input(IDS.NMF_TEST_PRED_REF_SELECTION, 'value'),
            Input(IDS.NMF_TEST_PRED_MODEL_SELECTION, 'value'),
            State(IDS.NMF_TEST_RESULTS, 'data'),
        ]
    )
    ...
    @app.callback(
        [
            Output(IDS.NMF_TEST_CORR_GRAPH, 'figure'),  # size, intervals?
            Output(IDS.NMF_TEST_CORR_TABLE, 'children'),
        ],
        [
            Input(IDS.NMF_TEST_CORR_INDICATOR_SELECTION, 'value'),
            Input(IDS.NMF_TEST_CORR_REF_SELECTION, 'value'),
            State(IDS.NMF_TEST_RESULTS, 'data'),
        ]
    )
