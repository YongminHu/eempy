...
eem_dataset_path = 'C:/PhD/Fluo-detect/_data/20240313_BSA_Ecoli/synthetic_samples_mfexem_3.json'
...
eem_new = np.concatenate([eem_up[:-9], eem_bot[-9:]], axis=0)
...
plot_eem(normalized_true_components[0] - normalized_parafac_components[0],
         ...
         title="Fingerprint residual in E. coli component"
         )
plot_eem(normalized_true_components[1] - normalized_parafac_components[1],
         ex_range=eem_dataset.ex_range,
         em_range=eem_dataset.em_range,
         plot_tool='matplotlib',
         vmin=-0.05,
...
# fig, ax = plt.subplots()
#
# ax.scatter(x, means_bsa, color='black', s=100, label='BSA component', zorder=3)
...
# )
# ax.scatter(x, means_ecoli, facecolors='none', edgecolors='black', s=100, label='E. coli component', zorder=3)
...
# ax.set_ylim([0.75, 3])
# ax.tick_params(axis='both', which='major', labelsize=12)
# ax.set_xlabel('KI concentration [mg/L]', fontsize=14)
# ax.set_ylabel(r"$F_{0}/F$", fontsize=14)
