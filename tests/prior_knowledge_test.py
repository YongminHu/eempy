...
for rank_target in range(params['n_components']):
    ...
    if (params['n_components']+1)//2 > 1:
        counts, bins, patches = axes[rank_target // 2, rank_target % 2].hist(fmax_ratio_target_train_filtered, bins=30,
        ...
        counts, bins, patches = axes[rank_target % 2].hist(fmax_ratio_target_train_filtered, bins=30,
                                                                             density=True, alpha=0.5, color='blue',
                                                                             label='training', zorder=0,
                                                                             edgecolor='black')
