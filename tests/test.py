...
#       --------PARAFAC--------
eem_dataset_path = 'C:/PhD/Fluo-detect/_data/_greywater/20240313_BSA_Ecoli/synthetic_samples.json'
...
# l1, l2, l3 = eems_svd_initialization(eem_dataset.eem_stack, rank=3)
# print(l1[0].shape)
